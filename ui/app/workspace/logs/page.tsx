				...
				if (log.status == "success" || log.status == "error") {
					setStats((prevStats) => {
						...
						if (log.fallback_index === 0) {
							...
							const userSuccessCount = (prevStats.user_facing_success_rate / 100) * prevStats.user_facing_total_requests;
							...
							newStats.user_facing_success_rate = (newUserSuccessCount / userFacingTotal) * 100;
						}
