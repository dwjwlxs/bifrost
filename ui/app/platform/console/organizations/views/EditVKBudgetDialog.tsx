...
export function EditVKBudgetDialog({
  open,
  onOpenChange,
  vk,
  teamId,
}: EditVKBudgetDialogProps) {
    ...
    <Dialog open={open} onOpenChange={handleClose}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Update the budget limit for <strong>{vk.name}</strong>. Set to 0
            for no limit.
          </DialogDescription>
        </DialogHeader>
            ...
            {vk.budget_limit !== undefined && vk.budget_limit > 0 && (
              <div className="mt-2">
                ...
                <div className="mt-1 flex justify-between text-xs">
                  ...
                  <span className="text-muted-foreground">
                    Limit: ${vk.budget_limit.toFixed(2)}
                  </span>
                </div>
              </div>
            )}
