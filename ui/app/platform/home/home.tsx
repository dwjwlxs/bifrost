		...
		<div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
			...
			<section className="bg-gray-50 px-4 py-24">
				<div className="container mx-auto">
					<h2 className="mb-16 text-center text-3xl font-bold">Why dRouter?</h2>
			...
			<section className="bg-blue-600 px-4 py-24 text-white">
				<div className="container mx-auto text-center">
					...
					<p className="mx-auto mb-8 max-w-2xl text-blue-100">Join thousands of teams using dRouter to build faster with AI.</p>
					<Link to="/platform/register">
