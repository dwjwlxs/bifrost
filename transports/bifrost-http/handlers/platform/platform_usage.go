...
func NewPlatformUsageHandler(config *lib.Config) *PlatformUsageHandler {
...
func (h *PlatformUsageHandler) buildUserFilters(ctx *fasthttp.RequestCtx, claims *platform.PlatformClaims) (logstore.SearchFilters, error) {
