...
type TableUser struct {
	...
	// Relationships
	Budgets   []configstoreTables.TableBudget   `gorm:"foreignKey:UserID;constraint:OnDelete:CASCADE" json:"budgets,omitempty"`
	RateLimit *configstoreTables.TableRateLimit `gorm:"foreignKey:RateLimitID" json:"rate_limit,omitempty"`
